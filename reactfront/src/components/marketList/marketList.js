...
export default function Profile() {
  ...
  function getMarketList() {
    axios
      .get(process.env.REACT_APP_API_URL + "marketList/lists/" + cookies.id)
      .then((response) => {
  ...
  function deleteList(id) {
    axios
      .delete(process.env.REACT_APP_API_URL + "listItems/" + id)
      .then((response) => {
        deleteMarklist(id);
      })
      .catch((error) => {
  ...
  function deleteMarklist(id) {
    axios
      .delete(process.env.REACT_APP_API_URL + "marketList/" + id)
      .then((response) => {
        getMarketList();
  ...
  function onFinish(values) {
    const recipe = FavoritesData.find(
      ...
      render(row) {
        return (
          <div className="button-table-list">
            <div>
              <Button type="default" onClickCapture={() => navToEdit(row.key)}>
                <EditOutlined />
              </Button>
            </div>
            <div>
